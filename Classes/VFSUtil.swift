...
@objc class VFSUtil: NSObject {
	...
	@objc static let keyChainSharingGroup = "eu.intelligentsolutions" // Enable Keychain Sharing capabilities in app and all app extensions that need to activate VFS and set key chain group to be the bundle ID for all and here
	@objc static let TEAM_ID = "S.A. Intelligent Solutions Ltd" // Apple TEAM ID
